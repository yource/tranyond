...
const theme = {
    ...
    // 全局/品牌色
    brand_primary: _global.primary,
    brand_primary_tap: _global.primaryTap,
    ...
    primary_button_fill: _global.primary,
    primary_button_fill_tap: _global.primaryTap,

    ghost_button_color: _global.primary, // 同时应用于背景、文字颜色、边框色
    ghost_button_fill_tap: `${_global.primary}99`, // alpha 60%  https://codepen.io/chriscoyier/pen/XjbzAW
    ...
    input_color_icon_tap: _global.primary,

    // tabs
    tabs_color: _global.primary,
    tabs_height: 42,
    tabs_font_size_heading: 15,

    // segmented_control
    segmented_control_color: _global.primary, // 同时应用于背景、文字颜色、边框色
    segmented_control_height: 27,
    segmented_control_fill_tap: `${_global.primary}10`,
